...
Annual mean temperatures were derived from ERA5 reanalysis data and compared with a Western European reference region. AMOC strength was obtained from the RAPID monitoring array.

The Carpathian Basin warmed at 0.557 °C per decade between 1980 and 2025, compared with 0.304 °C per decade in Western Europe. During 2004–2024, warming accelerated to 0.895 °C per decade in the Carpathian Basin while Western Europe warmed at 0.338 °C per decade. AMOC strength declined by 0.951 Sv per decade over the same period.
...
The results indicate that AMOC variability may contribute to enhanced warming in the Carpathian Basin relative to Western Europe, although further work is required to establish causal mechanisms.